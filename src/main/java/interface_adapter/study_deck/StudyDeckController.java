...
public class StudyDeckController {
    ...
    public void markKnown(int userId, int deckId, int cardIndex, String username) {
        MarkKnownInputData inputData = new MarkKnownInputData(userId, deckId, cardIndex, username);
